...
$(document).ready(function () {
  ...
  function get_pass_or_failure() {
    ...
    // こんな感じ [55, 100, 0, 30 ,90]

    // 変数「number」に入力した教科の数を代入します。5
  ...
  // for文の動き
  // i = 0からスタ-ト
  // subject_points[0] < 60 なのかを調べる
  // subject_points[0]は配列の1番目の値なので国語の点数
  // これが合格なら,i++を実行してiが1になる
  // subject_points[1] < 60 なのかを調べる
  // subject_points[1]は配列の2番目の値なので英語の点数
